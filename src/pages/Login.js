...
const Login = () =>
{
  ...
  const onFinish = (values) => {
    ...
    logService.oauth(values).then(({data}) => {
    ...
    <Layout className="layout-default layout-signin">
      ...
      <Content className="signin">
        <Row gutter={[24, 0]} justify="space-around">
          <Col
            ...
            md={{ span: 12 }}
          >
            <Title className="mb-15" level={2}>INICAR SESIÓN</Title>
      ...
      <Footer>
        ...
        <p className="copyright">
          {" "}
          Copyright © 2021 <a href="#pablo">Grupo Castro</a>.{" "}
        </p>
      </Footer>
    </Layout>
  );
